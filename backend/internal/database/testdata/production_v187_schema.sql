-- Schema only: production v187, 15 September 2026. No account records.
...
CREATE TABLE "alerts" (
	...
	, resolved_reason TEXT, resolved_note TEXT);
...
CREATE TABLE asset_class_config (
	...
	, cash_reserve REAL DEFAULT 0, q3_throttle_factor REAL, q4d_liquidity_factor REAL, sector TEXT, alert_label TEXT, alert_color TEXT, kind TEXT DEFAULT 'ASSET_CLASS', parent_code TEXT, is_portfolio_sleeve BOOLEAN DEFAULT 0, is_system_bucket BOOLEAN DEFAULT 0, allow_grouping BOOLEAN DEFAULT 1, allow_target_weight BOOLEAN DEFAULT 1, stock_allocation_ratio REAL NOT NULL DEFAULT 0.75);
...
CREATE TABLE asset_classes (
		...
		created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
		updated_at DATETIME DEFAULT CURRENT_TIMESTAMP
	, analysis_eligible BOOLEAN DEFAULT 1, instrument_scope TEXT DEFAULT 'BOTH', risk_bucket TEXT DEFAULT '');
...
CREATE TABLE company_mappings (
		...
		created_at DATETIME DEFAULT CURRENT_TIMESTAMP
	, template_id TEXT, security_id INTEGER);
...
CREATE TABLE etf_allocations (
		...
		last_updated DATETIME DEFAULT CURRENT_TIMESTAMP
	, tactical_status TEXT DEFAULT "BUY", base_weight REAL NOT NULL DEFAULT 0);
...
CREATE TABLE overlay_event_classes (
		...
		q3_sell_priority INTEGER,
		stage2_target_pct REAL,
		created_at DATETIME DEFAULT CURRENT_TIMESTAMP, stage1_recorded_reduction_value REAL DEFAULT 0,
...
CREATE TABLE overlay_events (
		...
		superseded_at DATETIME,
		notes TEXT
	, stage1_required_reduction_value REAL DEFAULT 0, stage1_recorded_reduction_value REAL DEFAULT 0, stage1_baseline_reserve_value REAL DEFAULT 0, stage1_expected_reserve_value REAL DEFAULT 0, stage1_import_baseline_at DATETIME, reserve_confirmed_at DATETIME, reserve_confirmed_value REAL, reserve_variance REAL, cash_confirmation_status TEXT DEFAULT '');
...
CREATE TABLE portfolio_rebalance_plan_rows (
		...
		note TEXT,
		created_at DATETIME DEFAULT CURRENT_TIMESTAMP, recorded_move_value REAL DEFAULT 0,
...
CREATE TABLE portfolio_sleeves (
		code TEXT PRIMARY KEY,
		asset_class_code TEXT NOT NULL,
		display_name TEXT NOT NULL,
		sleeve_type TEXT NOT NULL DEFAULT 'ALLOCATION',
		parent_code TEXT,
		allow_grouping BOOLEAN DEFAULT 1,
		allow_target_weight BOOLEAN DEFAULT 1,
		display_order INTEGER DEFAULT 999,
...
CREATE TABLE regime_assignments (
		id INTEGER PRIMARY KEY AUTOINCREMENT,
		security_ticker TEXT NOT NULL,
		security_type TEXT CHECK(security_type IN ('STOCK','ETF')) NOT NULL,
		regime_ticker TEXT NOT NULL,
		created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
		FOREIGN KEY (regime_ticker) REFERENCES regimes(ticker),
		UNIQUE(security_ticker, regime_ticker)
	);
...
CREATE TABLE "stock_analysis" ("id" INTEGER PRIMARY KEY, "ticker" TEXT, "name" TEXT NOT NULL, "grok_quality" REAL DEFAULT 0, "grok_value" REAL DEFAULT 0, "gemini_quality" REAL DEFAULT 0, "gemini_value" REAL DEFAULT 0, "grok_pt" REAL DEFAULT 0, "gemini_pt" REAL DEFAULT 0, "tipranks_pt" REAL DEFAULT 0, "analyst_pt" REAL DEFAULT 0, "upside_24m" REAL DEFAULT 0, "allocation" REAL DEFAULT 0, "market_cap" TEXT, "risk_profile" TEXT, "notes" TEXT, "updated_at" DATETIME DEFAULT CURRENT_TIMESTAMP, "created_at" DATETIME DEFAULT CURRENT_TIMESTAMP, "gpt_quality" REAL DEFAULT 0, "gpt_value" REAL DEFAULT 0, "gpt_pt" REAL DEFAULT 0, "current_price" REAL DEFAULT 0, "deer_flow_quality" REAL DEFAULT 0, "deer_flow_value" REAL DEFAULT 0, "perplexity_quality" REAL DEFAULT 0, "perplexity_value" REAL DEFAULT 0, "claude_quality" REAL DEFAULT 0, "claude_value" REAL DEFAULT 0, "council_quality" REAL DEFAULT 0, "council_value" REAL DEFAULT 0, "deer_flow_pt" REAL DEFAULT 0, "perplexity_pt" REAL DEFAULT 0, "claude_pt" REAL DEFAULT 0, "council_pt" REAL DEFAULT 0, "thesis" TEXT, "bear_case_pt" REAL DEFAULT 0, "base_case_pt" REAL DEFAULT 0, "bull_case_pt" REAL DEFAULT 0, "bear_probability" REAL DEFAULT 0, "base_probability" REAL DEFAULT 0, "bull_probability" REAL DEFAULT 0, "catalysts" TEXT, "last_contributed_at" DATETIME, "is_external" BOOLEAN DEFAULT FALSE, "council_run_id" TEXT, "council_run_label" TEXT, "overlay_sell_priority" INTEGER DEFAULT 3, "primary_asset_class" TEXT DEFAULT '', "is_watchlist" BOOLEAN DEFAULT FALSE, "security_type" TEXT DEFAULT 'STOCK', gemini_webui_output TEXT, gemini_webui_input_at TEXT, perplexity_webui_output TEXT, perplexity_webui_input_at TEXT, gpt_webui_output TEXT, gpt_webui_input_at TEXT, claude_webui_output TEXT, claude_webui_input_at TEXT, council_source_output TEXT, council_source_input_at TEXT, include_in_sizing BOOLEAN DEFAULT TRUE, security_id INTEGER, UNIQUE("ticker", "name"));
...
CREATE TABLE stock_groups (
		...
		parent_id TEXT,
		created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
		updated_at DATETIME DEFAULT CURRENT_TIMESTAMP, asset_class_code TEXT,
...
CREATE INDEX idx_portfolio_sleeves_active ON portfolio_sleeves(active, display_order);

CREATE INDEX idx_regime_assignments_regime ON regime_assignments(regime_ticker);

CREATE INDEX idx_regime_assignments_security ON regime_assignments(security_ticker);
